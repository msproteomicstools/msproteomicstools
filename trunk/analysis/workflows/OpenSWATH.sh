...
if [ "$mprophet" == "combined" ]; then
	source /cluster/apps/openms/openswath-testing/mapdiv/scripts/workflows/mProphet_combined.sh
else
	source /cluster/apps/openms/openswath-testing/mapdiv/scripts/workflows/mProphet_separate.sh
fi
